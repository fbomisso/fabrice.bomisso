...
--- Création de la table Tickets_support
...
-- Index sur les dates (utile pour les requêtes temporelles)
...
-- Insérer les données test dans les tables

-- Insérer les données test dans PLANS
INSERT INTO PLANS (
nom_plan,
prix_catalogue,
nb_utilisateurs_max,
...
-- Insérer les données de test dans ENTREPRISES
INSERT INTO ENTREPRISES (nom_entreprise, pays, secteur_activite, date_inscription)
VALUES
...
-- Insérer les données de test dans ABONNEMENTS
...
VALUES
-- DataViz Inc : Formule de démarrage puis Professionnel
(1, 1, '2024-01-15', '2024-03-31', 99.00),
(1, 2, '2024-04-01', NULL, 499.00),

-- Analytics Pro : Professionnel, puis résiliation en septembre
(2, 2, '2024-03-20', '2024-09-30', 499.00),

-- Business Intelligence Co : Professionnel depuis juin
(3, 2, '2024-06-10', NULL, 499.00),

-- Startup Data : Formule de démarrage depuis septembre
(4, 1, '2024-09-05', NULL, 99.00);

GO

-- Insérer les données de test dans UTILISATEURS
...
-- Insérer les données de test dans ACTIVITE
...
VALUES
-- Alice Martin (id = 1) : utilisation active
(1, '2024-12-15', 2, 5, 1, 3),
(1, '2024-12-16', 3, 8, 0, 2),
(1, '2024-12-17', 1, 3, 1, 1),

-- Bob Dupont (id = 2) : utilisation modérée
(2, '2024-12-15', 1, 2, 0, 1),
(2, '2024-12-16', 2, 4, 0, 2),

-- Charlie Moreau (id = 3) : peu d'activité
(3, '2024-12-17', 0, 0, 0, 0),
(3, '2024-12-15', 1, 1, 0, 0),

-- Diana Laurent (id = 4) : utilisation active
(4, '2024-12-15', 3, 10, 2, 4),
(4, '2024-12-16', 2, 6, 1, 2),

-- Eric Rousseau (id = 5) : faible activité avant départ
(5, '2024-07-15', 1, 1, 0, 1),
(5, '2024-07-16', 0, 0, 0, 0),

-- Fiona Dubois (id = 6) : utilisation active
(6, '2024-12-16', 4, 15, 3, 5),
(6, '2024-12-17', 2, 8, 1, 3),

-- Georges Petit (id = 7) : modérée
(7, '2024-12-15', 2, 5, 1, 2),
(7, '2024-12-17', 1, 3, 0, 1),

-- Hélène Lefevre (id = 8) : faible
(8, '2024-12-15', 1, 0, 0, 0),

-- Isabelle Mercier (id = 9) : nouvelle, activité test
(9, '2024-09-05', 1, 2, 1, 1),
(9, '2024-12-15', 2, 4, 1, 2);

GO

-- Insérer les données de test dans FACTURES
...
VALUES
-- DataViz Inc : factures mensuelles
...
-- Analytics Pro : factures jusqu'à résiliation en septembre
...
-- Insérer les données de test dans LIGNES_FACTURE
...
VALUES
-- DataViz Inc : factures de Formule de démarrage (jan-mar)
...
-- DataViz Inc : factures de Professionnel (avr-dec)
...
-- Analytics Pro : factures de Professionnel (mar-sep)
...
-- Business Intelligence Co : factures de Professionnel (juin-dec)
...
-- Startup Data : factures de Formule de démarrage (sep-dec)
...
-- Insérer les données de test dans TICKETS_SUPPORT
...
VALUES
-- DataViz Inc : tickets résolus et en cours
...
-- Analytics Pro : tickets non résolus avant résiliation
(2, '2024-08-20 10:00:00', NULL, 'Bogue', 'Élevée', 'Ouvert'),
(2, '2024-09-10 14:30:00', NULL, 'Facturation', 'Élevée', 'Ouvert'),

-- Business Intelligence Co : tickets actifs bien gérés
...
-- Startup Data : peu de tickets, usage récent
